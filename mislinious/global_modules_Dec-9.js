...
<span class="homeButton"><a href="index.html"><img src="images/home.png" width="100%"></span>\
				...
				<div id="thriive_world_sub_menu" onmouseover="display_thriive_world_submenu();" class="submenu-fadein">\
					<a href="thriive_world_audioa_videos.html"><div id="thriive_world_gallery_div" class="menu_itmes">wisdom videos/audios</div></a>\
					<a href="#"><div id="thriive_world_gmeditation_div" class="menu_itmes">thriive music</div></a>\
					...
					<a href="#"><div id="thriive_world_gmeditation_div" class="menu_itmes">articals</div></a>\
					<a href="news_letters_old.html"><div id="thriive_world_newsletter_div" class="menu_itmes">newsletter</div></a>\
				</div>\
...
function display_header_2(){
    ...
    document.write('<!--LOGIN ICON-->\
            <span id="signin_tag"><a class="anchorTagButton" href="login.html">\
        ...
        <span>&nbsp;&nbsp;<span id="Line">|</span>&nbsp; &nbsp;</span>');
    document.write('<!--LOGIN ICON-->\
            <span class="user_dropdown" id="signedin_tag" style="display:none;">\
                <strong>\
    ...
    document.write('<!--SEARCH ICON-->\
      <span id="signinBeforeClick" onclick="showSearch();">\
			...
			<a class="anchorTagButton"><span id="search"><strong>search </strong> </span> </a>\
      </span>\
...
<div class="footerDiv" id="FooterSection_Desktop">\
	...
	<div class="footerButtonDiv">\
		...
		<div class="caressDiv">\
			<div style="width:40%">\
				<a href="career_page.html"> <img id="carees" src="images/carees.png" width="100%"> </a>\
			</div>\
...
<div class="footerDiv" id="FooterSection_Mobile">\
	<div style="text-align:center; color:#fff; margin-top:5%">\
		...
		<!-- CAREERS BLOCK -->\
		<div>\
			<div style="width:25%;  margin:auto"> <a href="career_page.html">  <img src="images/carees.png" width="100%"></A> </div>\
                ...
                <div class="div_displayTable" style="padding: 0% 0% 0% 0%; width:100%;">\
                       <!--KEYWORD BUTTON-->\
                            <div class="keyword_Whathappening">\
                                ...
                                <input class="serch_Icon_Button" style="" type="submit" value=" "> <!-- SERCH BUTTON FOR LIST VIEW (it\'s not appear in the page,)-->\
                            </div>\
                   \
\
                            <!--MASTERERS BUTTON-->\
                            <div class="dropdown_Whathappening">\
                                <select class="dropdown_text_Whathappening" id="master" onchange="displayfilterbasedevents();">\
...
\
                            <!--WORKSHOPS BUTTON-->\
                            <div class="dropdown_Whathappening">\
                                <select class="dropdown_text_Whathappening" id="workshop" onchange="displayfilterbasedevents();">\
...
\                           <!--CITY BUTTON-->\
                            <div class="dropdown_Whathappening">\
                                <select class="dropdown_text_Whathappening" id="city" onchange="displayfilterbasedevents();">\
    ...
    document.write('<div class="div_displayTable" style="padding: 0% 0% 0% 0%; width:100%;">\
                    \
                     <div class="whatsHappeningButtons" style="margin-left:75%">\
                        <a> <img id="listViewActive_mobile"  onclick="displayListView();" src="images/whats_happning/list_button.png" width="130%" > </a>\
                    </div>\
\
                    <div class="whatsHappeningButtons">\
                       <a> <img id="gridViewActive_mobile" onclick="displayGridView();" src="images/whats_happning/grid_button_2.png" width="130%" > </a>\
                    </div>\
                    \
                </div>\
                    \
                <div class="div_displayTable" style="padding: 0% 0% 0% 0%; width:100%;">\
                    ...
                    \
                            <!--WORKSHOP BUTTON-->\
                            <div class="dropdown_Whathappening" style="margin-left:12%">\
                                <select class="dropdown_text_Whathappening">\
                    ...
                    \
                               <!--CITY BUTTON-->\
                            <div class="dropdown_Whathappening" style="margin-left:26%">\
                                <select class="dropdown_text_Whathappening">\
