...
//    Check First Name For Desktop
    ...
    elem=document.getElementById("website").value;
    if(elem==""){
        document.getElementById("website_error").innerHTML="Enter website";
        IsError = 'yes';
    }   
    
    //    Check location
    
    elem=document.getElementById("location").value;
    if(elem==""){
        document.getElementById("location_error").innerHTML="Enter Location";
        IsError = 'yes';
    }
        
    //    Check Modality-1
    
    elem=document.getElementById("Modality-1").value;
    if(elem==""){
        document.getElementById("Modality-1_error").innerHTML="Enter Modality Name";
        IsError = 'yes';
    }
       //    Check Modality-1
    
    elem=document.getElementById("referd").value;
    if(elem==""){
        document.getElementById("referd_error").innerHTML="Enter Referd by Name";
        IsError = 'yes';
    }
